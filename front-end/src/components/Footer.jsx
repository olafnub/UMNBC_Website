function Footer() {
    return (
        <footer>
            ...
            <img style={{height: "100px", width: "175px"}} src="https://1000logos.net/wp-content/uploads/2021/07/Minnesota-Golden-Gophers-logo.png" alt="Univeristy of Minnesota Logo"></img>
            <ul>
